...
> 来源：<web/terminal>。清洗痕迹见行尾 `（清:…）`。认知标记词表见 frontmatter 图例 / [[.claude/skills/对话标注/SKILL]]。
...
- 本技能是「对话标注」的**唯一活源**。[[10 Projects/ai-conversations/README]] 和 [[10 Projects/ai-conversations/_DIY-消化会话省token]] 只留指针，不重复规则（守 vault 的"唯一活源"原则，见 CLAUDE.md）。
