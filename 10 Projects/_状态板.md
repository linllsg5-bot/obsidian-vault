...
### Cognos — 第一数字承载（2026-08-04 立项，2026-08-13 网页竖切）
- **入口**：[[10 Projects/Cognos/_入口]]
- **状态**：首个可见网页竖切已完成并通过真实 Codex 连续性测试；尚未进入正式数据模型实现
...
- **下一步**：小林进入第一发生场做一次真实沟通；根据实际断裂增加最小的来源查询或历史重读，不先做固定 `ContextSnapshot`、Space 表或关系枚举
