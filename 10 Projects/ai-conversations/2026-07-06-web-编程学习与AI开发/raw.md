...
---
讲讲编程开发的八股文？都有啥？ai呢？
栈是啥？bfs是啥？我怎么没在编程教学书籍里看过？综合梳理编程面试题库与核心数据结构概念。综合梳理编程面试题库与核心数据结构概念。编程八股文是什么
...
实际工作中很多人几年都用不上手写BFS，但大厂面试把它当筛选门槛——所以催生了"八股文"这个现象。我有点迷惑不知道自己应该学什么诊断了用户困惑的多层次来源，权衡了优先级。诊断了用户困惑的多层次来源，权衡了优先级。你的迷惑是哪个层面的？这个很重要，否则我给的建议会打偏。Q: 你现在困惑的主要是哪个方向？
A: 其他，我来说Thought for 1sThought for 1s说吧。我不知道我做的东西需要涉及到什么，软件，以及ai，但是ai除了模型都是harness，似乎就是提示词？那好像也是软件和数据结构吗？最多加上系统什么的？验证了观察准确性，阐明了软件与AI的边界关系。验证了观察准确性，阐明了软件与AI的边界关系。你的观察基本准确，但值得说清楚一个关键点：
...
你现在做的东西——Claudian、prototype-spark——其实已经在走这条路了。困惑可能来自：看到别人说"学AI"，但你发现自己其实在写软件，然后怀疑自己走错了？学ai，那也是能调整模型才是吧，我没机会，最多只能接触小模型，意义似乎不大？相比于我要做的？但是我要做的真的能做出来吗？不涉及模型层的变革的话？或者一些更深的东西？识别了周期性模式，决定温暖地验证而非诊断。识别了周期性模式，决定温暖地验证而非诊断。"再而歇，再而竭"——原句是"一鼓作气，再而衰，三而竭"，你这版垫底的速度比原句还快。
