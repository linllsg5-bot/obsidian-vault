...
# Provenance Manifest: 2026-08-13 ~ 08-16 会话全量来源与拓扑
...
### 2026-08-16 新增：GPT App 主线/分支当前导出

| 标识 | 来源文件 | 消息数 | 归档位置 | 关系 |
| :--- | :--- | :--- | :--- | :--- |
| **GPT-Main-0816** | `C:\Users\lnp\Desktop\GitHub 项目查看助手.md` | 183 | `2026-08-15-gpt-Cognos第一发生场真实使用与第一组织切片/raw-main.md` | 当前主线继续发生后的 App 导出；与 branch 共享前 70 条 |
| **GPT-Branch-0816** | `C:\Users\lnp\Downloads\分支 · GitHub 项目查看助手.md` | 119 | `2026-08-15-gpt-Cognos第一发生场真实使用与第一组织切片/raw-branch.md` | 当前分支继续发生后的 App 导出；与 main 共享前 70 条 |

> 这两份 raw 不是 8/13、8/14 已归档 share 的重复，而是当前 GPT 主/分支会话的继续发生。
> 其中 `raw-branch.md` 已做 API 密钥脱敏（`[REDACTED: API key]`），原始导出中的密钥应按已泄露处理。
